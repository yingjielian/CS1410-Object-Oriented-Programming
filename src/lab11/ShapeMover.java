                                                  ...
                                                  Runnable
{
    ...
    public ShapeMover ()
    {
    	...
    	shapes = new Shape[]
    	    {
    	       new Rect    (130,  40,  60, 20, Color.cyan),
               new Rect    (210,  40,  20, 30, Color.BLUE),
               new Rect    (330,  140,  80, 10, Color.GREEN.darker()),
               new Rect    (130, 140, 100, 100, new Color (0.2f, 0.6f, 0.2f)),
    	       new Rect    ( 30, 190,  40, 25, Color.YELLOW),
    	       new Circle    (80,  40,  60, Color.RED),
               new Circle    (230,  40,  20, Color.BLUE.darker()),
               new Circle    (330,  40,  80, Color.GREEN),
               new Circle    (20, 140, 100, new Color (0.8f, 0.6f, 0.2f)),
    	       new Circle    ( 30, 140,  40, Color.YELLOW.darker())
    	    };
